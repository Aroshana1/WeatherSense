...
| npm | 9.x | `npm --version` |
| MongoDB | 6.x (optional, Phase 5+) | `mongod --version` |
...
See [`docs/auth0-setup-guide.md`](./docs/auth0-setup-guide.md) for step-by-step
...
│   │   ├── models/User.js      Mongoose user whitelist (Phase 5)
│   │   ├── app.js              Express app factory
│   │   └── server.js           HTTP entry point
│   └── tests/                  Jest unit tests (Phase 7)
...
│       └── pages/              Dashboard
├── docs/
│   └── auth0-setup-guide.md   ← Auth0 Dashboard config steps (Phase 6)
└── README.md                   This file
```
...
## Auth0 Integration — Phase 6 Configuration

> Full step-by-step instructions with screenshot placeholders:
> **[`docs/auth0-setup-guide.md`](./docs/auth0-setup-guide.md)**
...
| Database | MongoDB + Mongoose | Phase 5+ for user whitelist persistence |
| Testing | Jest | Phase 7 unit tests for the pure comfort index function |
...
npm test         # Jest unit tests (Phase 7)
...
*Built as a Fidenz assignment project. See [`docs/auth0-setup-guide.md`](./docs/auth0-setup-guide.md) for the full Auth0 configuration walkthrough.*
